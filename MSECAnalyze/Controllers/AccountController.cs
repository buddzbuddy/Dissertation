...
using MSECAnalyze.Filters;
using MSECAnalyze.Models;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    dataManager.Users.CreateUserAndAccount(model.UserName, model.Password, new { Password = model.Password });
                    dataManager.Users.Login(model.UserName, model.Password);
                    return RedirectToAction("Index", "Home");
                }
        ...
        public ActionResult Disassociate(string provider, string providerUserId)
        {
            ...
            if (ownerAccount == User.Identity.Name)
            {
                ...
                {
                    bool hasLocalAccount = OAuthWebSecurity.HasLocalAccount(dataManager.Users.GetUserId(User.Identity.Name));
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : "";
            ViewBag.HasLocalPassword = OAuthWebSecurity.HasLocalAccount(dataManager.Users.GetUserId(User.Identity.Name));
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        changePasswordSucceeded = dataManager.Users.ChangePassword(User.Identity.Name, model.OldPassword, model.NewPassword);
                    }
                    catch (Exception)
                    {
            ...
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    try
                    {
                        dataManager.Users.CreateAccount(User.Identity.Name, model.NewPassword);
        ...
        public ActionResult RemoveExternalLogins()
        {
            ...
            ViewBag.ShowRemoveButton = externalLogins.Count > 1 || OAuthWebSecurity.HasLocalAccount(dataManager.Users.GetUserId(User.Identity.Name));
