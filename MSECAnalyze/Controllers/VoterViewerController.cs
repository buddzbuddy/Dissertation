...
namespace MSECAnalyze.Controllers
{
    ...
    public class VoterViewerController : Controller
    {
        ...
        public string GetNameByEntityId(int Id, MSECAnalyzeEntityTypes eType)
        {
            if (eType == MSECAnalyzeEntityTypes.District)
                return dataManager.Districts.Get(Id).Name;
            if (eType == MSECAnalyzeEntityTypes.Locality)
                return dataManager.Localities.Get(Id).Name;
            if (eType == MSECAnalyzeEntityTypes.Street)
                return dataManager.Streets.Get(Id).Name;
            if (eType == MSECAnalyzeEntityTypes.House)
                return dataManager.Houses.Get(Id).Name;
            if (eType == MSECAnalyzeEntityTypes.Party)
            ...
            if (eType == MSECAnalyzeEntityTypes.Precinct)
